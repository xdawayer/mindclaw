...
import { fenceMemoryContent, MEMORY_FENCE_INSTRUCTION } from "./metrics/memory-fencing.js";
...
function buildMemorySection(params: {
  ...
  const raw = buildMemoryPromptSection({
  ...
  const fenced = fenceMemoryContent(content, "search-recall");
  return [MEMORY_FENCE_INSTRUCTION, "", fenced, ""];
}
