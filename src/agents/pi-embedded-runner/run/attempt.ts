...
import { resolveMetricsFlags } from "../../metrics/feature-flags.js";
import { tryRecordAgentMetrics } from "../../metrics/try-record-metrics.js";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // Best-effort session metrics recording — all agent paths converge here
        if (params.config && resolveMetricsFlags(params.config).sessionMetrics && params.agentDir) {
