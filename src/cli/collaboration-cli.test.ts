...
const collaborationValidateCommand = vi.fn<(opts: unknown, runtime: unknown) => Promise<void>>();
const collaborationExplainCommand = vi.fn<(opts: unknown, runtime: unknown) => Promise<void>>();
const collaborationAuditCommand = vi.fn<(opts: unknown, runtime: unknown) => Promise<void>>();
