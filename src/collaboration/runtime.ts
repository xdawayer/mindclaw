  ...
  return {
    auditEvent:
      normalizedMode === "shadow"
        ? ("slack-collaboration-shadow" as const)
        : normalizedMode === "enforced"
          ? ("slack-collaboration-enforced" as const)
          : null,
    ...
    memoryEventTypes: ["memory.collaboration.handoff", "memory.collaboration.published"] as Array<
      "memory.collaboration.handoff" | "memory.collaboration.published"
    >,
  };
}
