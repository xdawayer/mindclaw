...
const MemoryExperimentalSchema = z
  .object({
    contextFencing: z.boolean().optional(),
    citationTracking: z.boolean().optional(),
  })
  .strict()
  .optional();
...
const MemorySchema = z
  .object({
    ...
    experimental: MemoryExperimentalSchema,
  })
  .strict()
  .optional();
  ...
  .object({
    ...
    metrics: z
      .object({
        experimental: z
          .object({
            sessionMetrics: z.boolean().optional(),
          })
          .strict()
          .optional(),
      })
    ...
    skills: z
      .object({
        ...
        experimental: z
          .object({
            proposalTool: z.boolean().optional(),
          })
          .strict()
          .optional(),
      })
