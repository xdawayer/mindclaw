...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "collaboration.identities": "Collaboration Identities",
  "collaboration.identities.users": "Slack User Role Mapping",
  "collaboration.spaces": "Collaboration Spaces",
  "collaboration.spaces.projects": "Project Spaces",
  "collaboration.spaces.projects.*.channelId": "Project Space Channel ID",
  "collaboration.spaces.projects.*.defaultAgent": "Project Space Default Agent",
  "collaboration.spaces.projects.*.defaultDmRecipient": "Project Space Default DM Recipient",
  "collaboration.spaces.projects.*.roleDmRecipients": "Project Space Role DM Recipients",
  "collaboration.spaces.roles": "Role Spaces",
  "collaboration.spaces.roles.*.channelId": "Role Space Channel ID",
  "collaboration.spaces.roles.*.agentId": "Role Space Agent",
  "collaboration.routing": "Collaboration Routing",
  "collaboration.routing.explicitMentionsOverride": "Explicit Mention Route Override",
  "collaboration.routing.autoClassifyWhenUnspecified": "Auto Classify Unspecified Messages",
  "collaboration.routing.stickyThreadOwner": "Sticky Thread Owner",
  "collaboration.routing.internalConsultationChangesOwner": "Internal Consultation Changes Owner",
  "collaboration.sync": "Collaboration Sync",
  "collaboration.sync.dmToShared": "DM To Shared Sync Policy",
  "collaboration.sync.dmToShared.mode": "DM To Shared Sync Mode",
  "collaboration.sync.dmToShared.approver": "DM To Shared Sync Approver",
